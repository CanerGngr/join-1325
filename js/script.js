function animateLogo() {
    ...
    setTimeout(() => {
        ...
        svgLogo.style.transition = 'width 1s cubic-bezier(.77,0,.18,1), height 1s cubic-bezier(.77,0,.18,1), left 1s cubic-bezier(.77,0,.18,1), top 1s cubic-bezier(.77,0,.18,1)';
